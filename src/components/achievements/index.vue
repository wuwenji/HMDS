    ...
    <div class="data-list">
      <table border="1" borderColor="#ccc" class="john-table">
        ...
        <tr>
          ...
          <td v-if="department != 3 && tableData.workTime.length < 3">-</td>
        </tr>
      </table>
    </div>
  </div>
